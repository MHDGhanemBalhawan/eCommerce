    ...
    <div class="row row-offcanvas row-offcanvas-left">
		...
		<div><?php include_once 'includes/leftsidebar.php'; ?></div>
            ...
            <div class="col-xs-12 col-sm-8">
				...
				<div id="details" style="overflow-x:auto;" align="center">		
				<?php
						...
						$product_id = $_GET['pro_id'];
							...
							$get_pro = "SELECT * FROM tbl_product WHERE product_id=$product_id";
							...
							echo "
								<div id='details'>
									...
									<p><b> £ $pro_price </b></p>
									<p>$pro_description</p>
									<a href='index.php?pro_id=$pro_id'><button type='button' style='transform:scale(1.25,1);float:left;margin-left:16px;'>Go Back</button></a>
