...
if($_FILES['image']['name'] != ''){
			...
			$image_path = 'customer_images/'.$image_name;
			$image_db_path = 'customer_images/'.$image_name;
			
			if($image_size < 10000000){
				if($image_ext == 'jpg' || $image_ext == 'png' || $image_ext == 'gif'){
					if(move_uploaded_file($image_tmp,$image_path)){
						$update_sql = "UPDATE tbl_customer SET customer_username = '$customer_username', customer_title = '$title', customer_first_name= '$first_name', customer_last_name = '$last_name', customer_email = '$email', customer_address = '$address', customer_post_code = '$post_code', customer_city = '$city', customer_country = '$country', customer_phone = '$phone', customer_mobile = '$mobile', customer_image = '$image_db_path', cust_date_created='$date' WHERE customer_id = '$_POST[cid]'";
			...
			$update_sql = "UPDATE tbl_customer SET customer_username = '$customer_username', customer_title = '$title', customer_first_name= '$first_name', customer_last_name = '$last_name', customer_email = '$email', customer_address = '$address', customer_post_code = '$post_code', customer_city = '$city', customer_country = '$country', customer_phone = '$phone', customer_mobile = '$mobile', cust_date_created='$date' WHERE customer_id = '$_POST[cid]'";
			if(mysqli_query($conn,$update_sql)){
...
?>
	...
	<!-- Hidden Test for id -->
	 ...
	 <div id="myacc_wrap" style="overflow-x:auto;">
