    ...
    <div class="navbar navbar- navbar-inverse" role="navigation">
        ...
        <div class="collapse navbar-collapse" id="navbar-collapse-3">
          <ul class="nav navbar-nav navbar-right">
			<li><a href="index.php">Home</a></li><?php echo "<script>window.open('../index.php', '_self')</script>"; ?>
...
<span id="shopping_cart" class="pull-right">
							...
							?>
							<b style="color:yellow">Cart:</b> Items: <?php total_items(); ?>-Price: £<?php total_price(); ?><a href="view_cart.php" style="color:yellow">Go to Cart</a>
							<?php
								if(!isset($_SESSION['customer_email'])){
