		...
		<div><?php include_once 'includes/leftsidebar.php'; ?></div>
            <div class="col-xs-12 col-sm-8">
				...
				<div class="panel panel-heading">
						<h3>Contact Us</h3>
				<?php if(!empty($errors)): ?>
				<div class="alert alert-danger" align="left" style="padding-left:5%;"><ul><li><?php echo implode('</li><li>', $errors); ?></li></ul>
				</div>
				<?php endif; ?>
				</div>
				<form class="form-horizontal" action="contact.php" method="post" role="form">
					<div class="form-group">
						...
						<div class="col-sm-7">
							<input type="text" class="form-control" name="name" placeholder="Name" id="name" <?php echo isset($fields['name']) ? ' value="' .e($fields['name']). '"'  : '' ?>>
						</div>
					</div><!--form-group-->
					<div class="form-group">
						<label for="email" class="col-sm-3 control-label">Email Address *</label>
						<div class="col-sm-7">
							<input type="text" class="form-control" name="email" placeholder="Email" id="email" <?php echo isset($fields['email']) ? ' value="' .$fields['email']. '"'  : '' ?>>
						</div>
					</div><!--form-group-->
					<div class="form-group">
						<label for="subject" class="col-sm-3 control-label">Subject *</label>
						<div class="col-sm-7">
							<input type="text" class="form-control" name="subject" placeholder="Subject" id="subject" <?php echo isset($fields['subject']) ? ' value="' .e($fields['subject']). '"'  : '' ?>>
						</div>
					</div><!--form-group-->
					<div class="form-group">
						<label for="comment" class="col-sm-3 control-label" >Comment *</label>
						<div class="col-sm-7">
							<textarea class="form-control" rows="10" name="comment" style="resize:none;"><?php echo isset($fields['comment']) ? e($fields['comment'])  : '' ?></textarea>
						</div>
					</div><!--form-group-->
					<div class="form-group">
