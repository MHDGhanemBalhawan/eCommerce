...
<?php
	...
	//echo $id , $key;
	$sql = "SELECT * FROM `tbl_customer` WHERE customer_id='". mysqli_escape_string($conn,$id) ."' AND verification_key='" . mysqli_escape_string($conn,$key) . "' AND active IS NULL";
	...
	if($count == 1){
		$update_sql = "UPDATE tbl_customer SET active = 1 WHERE customer_id=$id";
		$update_user = mysqli_query($conn, $update_sql);
		if($update_user){
		...
		<div><?php include_once 'includes/leftsidebar.php'; ?></div>
            <div class="col-xs-12 col-sm-8">
				...
				<div class="panel panel-heading">
						<h3 align="center">Account Verification</h3>
